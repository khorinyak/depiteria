...
window.DEPITERIA_EDIT = {
  ...
  gallery: [
    ...
    { type: "video", src: "assets/work_gallery/gallery_promo_video_square.mp4", alt: "Видео работ", preload: "metadata" },
    { type: "video", src: "assets/work_gallery/gallery_slideshow_square.mp4", alt: "Слайдшоу работ", preload: "auto" },
    { type: "video", src: "assets/work_gallery/review_slideshow_square.mp4", alt: "Слайдшоу отзывов", preload: "auto" }
  ]
};
